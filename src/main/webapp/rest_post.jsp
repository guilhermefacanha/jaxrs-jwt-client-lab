...
<body>
	...
	<h3>Users</h3>
	<form class="form-style-9" action="restpost.do" method="post">
		<ul>
		...
		<ul style="height:310px">
			<li>Body:</li>
			<li><textarea id="param" name="param" class="field-style field-split align-left" style="width: 300px;height:300px;" rows="80" cols="20"> </textarea></li>
		</ul>
		<ul>
			<li>Repeat:</li>
